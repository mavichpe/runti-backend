<div class="stickers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('recibe'); ?></th>
			<th><?php echo $this->Paginator->sort('created'); ?></th>
			<th><?php echo $this->Paginator->sort('estado'); ?></th>
			<th><?php echo $this->Paginator->sort('sticker'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($stickers as $sticker): ?>
	<tr>
		<td><?php echo h($sticker['Sticker']['id']); ?>&nbsp;</td>
		<td><?php echo h($sticker['Sticker']['enviado']); ?>&nbsp;</td>
		<td><?php echo h($sticker['Sticker']['recibe']); ?>&nbsp;</td>
		<td><?php echo h($sticker['Sticker']['created']); ?>&nbsp;</td>
		<td><?php echo h($sticker['Sticker']['estado']); ?>&nbsp;</td>
		<td><?php echo h($sticker['Sticker']['sticker']); ?>&nbsp;</td>
		<td class="actions">
